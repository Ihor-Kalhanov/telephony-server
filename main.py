...
AGENT_CONFIG = ChatGPTAgentConfig(
    ...
    initial_message=BaseMessage(text="What up guys, its me - Ihor Kalhanov and I am the developer who came to show you this product"),
...
async def api_start_outbound_call(to_phone: str = Form(...)):
    try:
